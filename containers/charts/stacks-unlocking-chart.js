...
const StacksUnlockingChart = ({ address, STXUSD, handleOnChange, ...rest }) => {
  ...
  return (
    <Card mt={3} title="STX unlocking schedule">
      <Section py={6}>
        ...
        <Type mb={6} fontWeight="normal">
          Enter a conversion rate for USD per Stack token to view how the value of this address's allocation will unlock
          over time.
        </Type>
        <Input
          mb={6}
          onChange={(e) => handleOnChange({ STXUSD: e.target.value })}
          value={STXUSD}
        ...
        <Type mb={6} fontWeight="light" fontSize={1}>
          ...
          and may not reflect their current pricing or any market data, which may be higher or lower than what is shown
          here. There is no guarantee that the market cap shown will be in existence at any particular time, or that
          Stacks Tokens can be sold at a price that is more advantageous or disadvantageous for a particular buyer at
