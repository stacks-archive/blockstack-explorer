            ...
            <Box width={[1, 1, 3/4]} pt={4}>
              <Card>
                ...
                <Card.Content>
                  ...
                  <Type.p fontSize="23px" mt={1}>{accounting.formatNumber(account.vesting_total * 10e-7)}</Type.p>
              ...
              <Card>
                ...
                <Card.Content>
                  ...
                  <ResponsiveContainer height={500}>
                    <LineChart data={convertedCumulative} margin={{ top: 30, right: 30, bottom: 30, left: 30 }}>
                      <XAxis
                        dataKey="block"
                        type="number"
